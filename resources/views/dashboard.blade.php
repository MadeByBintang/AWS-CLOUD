...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div class="bg-card border border-rim rounded-2xl px-[22px] py-5">
            ...
            @foreach ([['icon' => '🗄', 'label' => 'Storage', 'used' => $storageUsed ?? 4.5, 'total' => $storageQuota ?? 10, 'unit' => 'GB', 'pct' => $storagePercent ?? 45, 'grad' => 'from-accent to-accent-cyan'], ['icon' => '📂', 'label' => 'Bucket Limit', 'used' => $totalBuckets ?? 0, 'total' => $bucketLimit ?? 5, 'unit' => 'bucket', 'pct' => $bucketPercent ?? 0, 'grad' => 'from-accent-cyan to-accent-green'], ['icon' => '🔑', 'label' => 'Access Keys', 'used' => $totalKeys ?? 0, 'total' => $keyLimit ?? 3, 'unit' => 'keys', 'pct' => $keyPercent ?? 0, 'grad' => 'from-accent-orange to-accent-red'], ['icon' => '⚙', 'label' => 'Compute Units', 'used' => $computeUsed ?? 0, 'total' => $computeLimit ?? 100, 'unit' => 'vCPU·h', 'pct' => $computePercent ?? 0, 'grad' => 'from-accent-purple to-accent']] as $q)
